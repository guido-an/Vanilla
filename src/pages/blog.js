        ...
        <div className='wrapper-categories'>
          <div className='input-wrapper'>
            <div className='switch'>
              <input onChange={onCategoryChange} name='Web Development' id='switch-1' type='checkbox' className='switch-input' />
              <label htmlFor='switch-1' className='switch-label'>Web Development</label>
            </div>
            <div>Web Development</div>
          </div>
          <div className='input-wrapper'>
            <div className='switch'>
              <input onChange={onCategoryChange} name='Social Media Marketing' id='switch-2' type='checkbox' className='switch-input' />
              <label htmlFor='switch-2' className='switch-label'>Social Media</label>
            </div>
            <div>Social Media</div>
          </div>
          <div className='input-wrapper'>
            <div className='switch'>
              <input onChange={onCategoryChange} name='Web Marketing' id='switch-3' type='checkbox' className='switch-input' />
              <label htmlFor='switch-3' className='switch-label'>Web Marketing</label>
            </div>
            <div>Web Marketing</div>
          </div>
          <div className='input-wrapper'>
            <div className='switch'>
              <input onChange={onCategoryChange} name='Social Media Marketing' id='switch-4' type='checkbox' className='switch-input' />
              <label htmlFor='switch-4' className='switch-label'>Graphic Design</label>
            </div>
