      ...
      <section className='prenota-da-mangiare-section'>
        <div className='prenota-da-mangiare-hero'>
          <div>
            ...
            <p className='prenota-da-mangiare-cta-text hideOnDesktop'>
              Mettiti In Contatto Con Noi Ora
              <a href='https://wa.me/+393516711311'><img src={whatsapp} alt='whatsapp-icon' /></a>
            </p>
            <p className='prenota-da-mangiare-cta-text hideOnMobile'><a style={{ color: '#777', textDecoration: 'none' }} href='mailto:info@vanillamarketing.it?subject=Prenota Da Mangiare'> Mettiti In Contatto Con Noi Ora ></a></p>
          </div>
          <div>
