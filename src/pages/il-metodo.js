  ...
  return (
    <Layout path='/' locale={locale} data={data}>
      ...
      <section className='metodo-section'>
        <p>Il metodo Digital Creators utilizza l’approccio creativo e umanistico, una capillare capacità di lettura dei dati analitici e la profonda conoscenza di soluzioni tecnologiche. </p>
        <p>Il nostro metodo è diventato famoso perché è capace di tre caratteristiche principali:</p>
        <ul>
          <li>è flessibile</li>
        ...
        ><strong>Come nasce il giusto metodo?</strong><br />Dopo anni di strategie sviluppate e risultati raggiunti in segmenti del mercato tanto diversi tra di loro abbiamo sviluppato un metodo che ha la capacità di essere del tutto flessibile alle esigenze specifiche.
        </p>
        <p>Il Digital Creators Method è il nostro modo di raggiungere risultati in maniera chiara e soddisfacente.
Nasce dall’esperienza formata grazie a titoli di studio, master, specializzazioni e poi anche con la formazione continua, strumento in cui crediamo moltissimo e grazie al lavoro appassionato che portiamo avanti ogni giorno.
        </p>
        ...
        <p>Da qui si procede fissando degli obiettivi realistici e seri; questo è importante perché solo con obiettivi di questo tipo, definiti in gergo SMART (specific, measurable, achievable, relevant, timely), possiamo raggiungere risultati soddisfacenti senza spreco di risorse.
Ultima fase è quella della messa online della strategia, dell’analisi continua e della fase di testing che ci aiuta a capire come sta performando la struttura impostata.
        </p>
        <p>Dalla nostra esperienza abbiamo, inoltre, capito che più una strategia è capace di includere azioni sinergiche tanto più sarà efficace e i suoi risultati soddisfacenti.</p>
