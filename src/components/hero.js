    ...
    <section className='hero'>
     ...
     That Work.
        ...
        <div class='video-container' id='video-mobile'>
          <iframe width='100%' height='auto' src='https://www.youtube.com/embed/Z_12MmcTHig' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen />
        </div>
      </div>
    </section>
  )
